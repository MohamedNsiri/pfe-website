...
def validate(request):
    try:
        ...
        results = validator.validate_with_nlp()
        gen_results = validator.generate_nlp_report(results)
...
def add_user(request):
    try:
        ...
        user = User.objects.create_user(
            ...
            is_active=False  # User will be inactive until confirmed
        )
        ...
        confirmation_url = request.build_absolute_uri(reverse('confirm-user', kwargs={'token': confirmation_token}))
